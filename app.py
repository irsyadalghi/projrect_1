...
def create_byage_df(df):
    ...
    byage_df['age_group']=pd.Categorical(byage_df['age_group'],['Youth','Senior','Adult'])
...
all_df=pd.read_csv(r"C:\Users\irsyad alghi fary\Downloads\project 1\all_data.csv")
...
with col1:
    ...
    ax.set_title('Number of Customery by gender ',loc='center',fontsize=50)
    ax.set_ylabel(None)
    ax.set_ylabel(None)
...
with col2:
    ...
    ax.set_title('Number of Customery by Age',fontsize=50)
    ax.set_xlabel(None)
    ax.set_ylabel(None)
    ax.tick_params(axis='y',labelsize=30)
    ax.tick_params(axis='x',labelsize=35)
